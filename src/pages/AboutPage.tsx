          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl font-bold text-foreground">
                About <span className="gold-gradient-text italic">New Haven Restaurant</span>
              </h1>
            </motion.div>
            ...
            >
              <p className="text-muted-foreground text-lg leading-relaxed mb-8">
               "We offer a variety of Kenyan traditional cuisine with a very unique burst of flavours serving you the best required taste of the motherland from breakfast to diner ...you are always welcome"
              </p>
            </motion.div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              {[
                ...
                { icon: Mail, text: "hello@newhavenrestaurant.co.ke" },
                { icon: Instagram, text: "@New Haven Restaurant" },
