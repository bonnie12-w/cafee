    ...
    <footer className="border-t border-border bg-card/30">
      <div className="container mx-auto px-4 sm:px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h3 className="font-display text-xl font-bold gold-gradient-text">New Haven Restaurant</h3>
                <p className="text-[10px] tracking-[0.3em] uppercase text-muted-foreground">NH</p>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              ...
              <p className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-primary" /> hello@newhavenrestaurant.co.ke
              </p>
              <p className="flex items-center gap-3">
                <Instagram className="w-4 h-4 text-primary" /> @New Haven Restaurant
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-xs text-muted-foreground/50">
          © 2026 New Haven Restaurant. All rights reserved.
        </div>
      </div>
    </footer>
  );
